      ...
      <section className="bg-white pt-20 sm:pt-28 pb-6 sm:pb-16 lg:pb-24 text-center relative overflow-hidden bg-grid-lines">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative z-20 space-y-0">
            <h1 className="text-3xl sm:text-6xl lg:text-[90px] font-bold text-[#ffc82e] font-montserrat tracking-tight leading-[0.95] text-center drop-shadow-xs">
          ...
          <div className="group relative z-10 -mt-3 sm:-mt-10 lg:-mt-14 rounded-[4px] overflow-hidden shadow-2xl max-w-5xl mx-auto border border-gray-100 cursor-pointer">
  <img
    src="/37264.jpg"
  ...
  />
      ...
      <section className="pt-6 sm:pt-16 pb-6 sm:pb-12 bg-white bg-grid-lines">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-6 gap-5 lg:gap-3 items-start">
            <div className="lg:col-span-5 space-y-4">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0d3b2e] font-montserrat tracking-tight leading-snug">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <span className="inline-block text-[#0d3b2e] text-s font-bold font-montserrat">
          ...
          {/* 3 Step Process Bar - Desktop Grid View */}
          <div className="hidden sm:grid sm:grid-cols-3 bg-white rounded-full border border-gray-200 shadow-md p-4 sm:p-6 gap-6 text-center max-w-4xl mx-auto transform hover:scale-[1.01] transition-transform duration-300">
